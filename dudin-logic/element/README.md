...
* Поправил пару мелких недочетов работы с локальной памятью и добавил доп.проверку для простых текстовых серийных случаев.

#### Версия 4.3 (23 августа 2018)
* Добавил возможность "Выдавать по изменению fill". Теперь можно опционально менять только _fill_, не посылая команду _control_=2.

#### Версия 4.2.1 (20 августа 2018)
* HOTFIX: Если при убирании попытаться выдать что-то не обнулялась _control_ переменная в "5"
...
* добавил проверку условий на _fill_
